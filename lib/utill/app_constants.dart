import 'package:snapbuy/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'SNAPBUY';

  static const String BASE_URL = 'https://snapbuy.dexsnap.com';
