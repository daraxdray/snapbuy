...
import 'package:snapbuy/view/screen/auth/auth_screen.dart';
import 'package:snapbuy/view/screen/dashboard/dashboard_screen.dart';
import 'package:snapbuy/view/screen/maintenance/maintenance_screen.dart';
import 'package:snapbuy/view/screen/onboarding/onboarding_screen.dart';
import 'package:snapbuy/view/screen/splash/widget/splash_painter.dart';
        ...
        clipBehavior: Clip.none, children: [
          ...
          Center(
            child: Column(
              ...
              children: [
                Image.asset(Images.logo_image, height: 250.0, fit: BoxFit.scaleDown, width: 250.0),
              ],
            ),
          ),
        ],
